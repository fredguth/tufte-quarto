...
![David Hume, Scottish Enlighten- ment philosopher, historian, economist, librarian and essayist.](/Images/hume.svg){.column-margin}
...
::: {.content-hidden unless-format="html" .column-body #fig-elephant #blind-men}
</BR>
</BR>

![The Blind Men and the Elephant.](/Images/elephant-colored.png)
...
::: {.content-hidden unless-format="pdf" #fig-anatomy}

![](/Images/anatomy.pdf){.column-body  width=70%}
...
::: {layout-ncol=2 layout-valign="bottom" #fig-termite}
...
![A brief history of connectionism. Adapted from @tishby2020DeepMath.](/Images/winters.png){width=70%}
